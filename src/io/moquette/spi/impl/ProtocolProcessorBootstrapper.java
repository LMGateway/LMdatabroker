    ...
    public ProtocolProcessor init(IConfig props, List<? extends InterceptHandler> embeddedObservers,
        ...
        if (authenticator == null) {
            ...
            if (passwdPath.isEmpty()) {
            	...
            	InputStream is = Thread.currentThread().getContextClassLoader().getResourceAsStream("password_file.conf");
                authenticator = new ResourceAuthenticator(new InputStreamReader(is));
            }
