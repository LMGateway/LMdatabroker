...
public class Server {
    ...
    public void startServer() throws IOException {
        ...
        InputStream is = Thread.currentThread().getContextClassLoader().getResourceAsStream("moquette.conf");
        final IConfig config = new ResourceLoaderConfig(new InputStreamReader(is),filesystemLoader);
        startServer(config);
    }

    private static File defaultConfigFile() {
        String configPath = System.getProperty("moquette.path", null);
        String tt = Thread.currentThread().getContextClassLoader().getResource("moquette.conf").getPath();
        return new File(configPath, tt);
    }
